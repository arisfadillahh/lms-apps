...
export default function AddLevelButton() {
    ...
    const handleSubmit = () => {
        ...
        startTransition(async () => {
            try {
                const response = await fetch('/api/admin/curriculum/levels', {
                    method: 'POST',
                ...
                if (!response.ok) {
                    ...
                    setError(data.error || 'Gagal menambah level');
                    return;
                }
            ...
            {open && (
                <div style={backdropStyle} onClick={handleClose}>
                    <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
                        <h3 style={titleStyle}>Tambah Level Baru</h3>
                        ...
                        <div style={fieldStyle}>
                            ...
                            <input
                                ...
                                placeholder="Contoh: Explorer, Creator, Master"
                                style={inputStyle}
                                autoFocus
                            />
                        </div>
