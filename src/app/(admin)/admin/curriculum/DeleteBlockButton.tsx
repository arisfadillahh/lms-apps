    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
      <Dialog.Root open={open} onOpenChange={setOpen}>
        <Dialog.Trigger asChild>
          <button type="button" style={deleteButtonStyle} disabled={isPending}>
            <Trash2 size={14} />
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content style={contentStyle}>
            <div style={headerStyle}>
              ...
              <Dialog.Title style={titleStyle}>Hapus Block?</Dialog.Title>
            ...
            <Dialog.Description style={descriptionStyle}>
              Anda akan menghapus block <strong>"{blockName}"</strong> beserta semua lesson di dalamnya.
            ...
            <div style={buttonContainerStyle}>
              ...
              <button type="button" onClick={handleDelete} style={confirmDeleteButtonStyle} disabled={isPending}>
                {isPending ? 'Menghapus...' : 'Ya, Hapus Block'}
              </button>
            </div>
          </Dialog.Content>
        </Dialog.Portal>
