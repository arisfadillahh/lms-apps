...
import { Search, Mail, ChevronDown, LogOut, Settings } from 'lucide-react';
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    ...
                    {/* Notification Dropdown with Bell Icon built-in */}
...
const iconButtonStyle = {
    ...
    justifyContent: 'center',
    padding: '0.6rem',
    borderRadius: '10px', // slightly clearer styling for buttons
    transition: 'all 0.2s',
