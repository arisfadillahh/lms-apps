    ...
    <nav className="fixed inset-x-0 top-3 z-50 px-3 sm:top-4 sm:px-5" aria-label="Portfolio navigation">
      <div className="mx-auto flex min-h-16 max-w-6xl items-center justify-between rounded-2xl border border-white/10 bg-[#0e1740]/65 px-4 shadow-[0_14px_45px_rgba(3,11,40,.22)] backdrop-blur-xl sm:px-5">
        ...
        <div className={`${open ? 'absolute inset-x-3 top-[4.5rem] grid rounded-2xl border border-white/10 bg-[#0e1740]/95 p-2 shadow-2xl backdrop-blur-xl' : 'hidden'} sm:static sm:flex sm:items-center sm:gap-1 sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none`}>
          <a href="#journey" onClick={close} className="inline-flex min-h-11 items-center gap-2 rounded-xl px-3 text-sm font-bold text-white/65 hover:bg-white/10 hover:text-white"><Compass size={16} /> Journey</a>
          <a href="#projects" onClick={close} className="inline-flex min-h-11 items-center gap-2 rounded-xl px-3 text-sm font-bold text-white/65 hover:bg-white/10 hover:text-white"><FolderKanban size={16} /> Projects</a>
          <a href="#character" onClick={close} className="inline-flex min-h-11 items-center gap-2 rounded-xl px-3 text-sm font-bold text-white/65 hover:bg-white/10 hover:text-white"><HeartHandshake size={16} /> Growth</a>
    ...
    <header id="top" className="relative grid min-h-screen items-center px-5 pb-20 pt-28 sm:px-8">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-8 lg:grid-cols-[.98fr_1.02fr]">
        <div>
          ...
          <div className="mt-7 flex flex-wrap gap-3"><a href="#projects" className="inline-flex min-h-12 items-center gap-2 rounded-2xl bg-clevio-green px-5 font-black text-[#0e1740] hover:-translate-y-1">Enter My Portfolio <ArrowUpRight size={18} /></a><a href="#journey" className="inline-flex min-h-12 items-center gap-2 rounded-2xl border border-white/15 bg-white/5 px-5 font-black text-white backdrop-blur hover:bg-white/10">View Learning Journey <ChevronRight size={17} /></a></div>
