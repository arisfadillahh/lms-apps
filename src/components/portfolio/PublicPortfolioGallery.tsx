...
export default function PublicPortfolioGallery({ projects }: { projects: PublicProject[] }) {
  ...
  return <>
    <section id="projects" data-portfolio-reveal className="relative z-10 mx-auto w-full max-w-6xl px-5 py-24 sm:px-8 sm:py-28">
      <div className="mb-10 grid gap-4 sm:grid-cols-[90px_1fr] sm:gap-5"><div className="pt-2 text-xs font-black tracking-[.18em] text-clevio-green">02</div><div><h2 className="m-0 max-w-full text-[clamp(2.35rem,11vw,4.4rem)] font-black uppercase leading-[.9] tracking-[-.048em] sm:text-[clamp(2.6rem,5.4vw,4.4rem)] lg:text-[clamp(3rem,6.6vw,5.1rem)]">Project Universe</h2><p className="mt-5 max-w-2xl text-base font-semibold leading-relaxed text-white/65">Setiap project adalah cerita tentang ide, proses, tantangan, dan hal baru yang dipelajari.</p></div></div>
