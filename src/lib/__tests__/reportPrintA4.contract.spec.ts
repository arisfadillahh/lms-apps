...
describe('A4 report print contract', () => {
  ...
  it('removes root overflow constraints and keeps competency cards together', () => {
    ...
    expect(source).toContain('.report-competency-card { padding: 12px !important; }');
    expect(source).toContain('.report-competency-card p { margin-top: 9px !important; font-size: 10px !important; line-height: 1.35 !important; }');
